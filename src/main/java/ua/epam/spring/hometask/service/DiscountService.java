...
public interface DiscountService {
     ...
     * @return discount Dto with chosen discount strategy class and discount value from 0 to 100
     */
    DiscountResultDto getDiscount(@Nullable User user, @Nonnull Event event, @Nonnull LocalDateTime airDateTime, int numberOfTickets);
